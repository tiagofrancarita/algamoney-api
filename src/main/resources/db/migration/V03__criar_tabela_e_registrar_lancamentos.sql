...
CONSTRAINT fk_lancamentoPessoa FOREIGN KEY (codigo_pessoa) REFERENCES pessoa (codigo),
CONSTRAINT fk_lancamentoCategoria FOREIGN KEY (codigo_categoria) REFERENCES categoria (codigo)
)
